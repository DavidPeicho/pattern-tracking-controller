...
int main() {
  ...
  const char* testImgPath = "assets/input_photo.jpg";
  const char* arrowUpImgPath = "assets/arrow_up.jpg";

  testFrame = cv::imread(testImgPath, CV_LOAD_IMAGE_GRAYSCALE);
  arrowUpFrame = cv::imread(arrowUpImgPath, CV_LOAD_IMAGE_GRAYSCALE);
